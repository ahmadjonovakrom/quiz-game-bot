...
# FIX: these were duplicated verbatim from database/chats.py.
# Import from the canonical location to avoid divergence.
from .chats import ensure_chat, deactivate_chat  # noqa: F401  (re-exported for compat)
