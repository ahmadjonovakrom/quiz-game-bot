    ...
    with closing(get_conn()) as conn, conn:
        ...
        conn.execute("""
            CREATE TABLE IF NOT EXISTS players (
                ...
                duel_games_played INTEGER DEFAULT 0,
                duel_games_won INTEGER DEFAULT 0,
        ...
        if "duel_games_played" not in player_columns:
            conn.execute("ALTER TABLE players ADD COLUMN duel_games_played INTEGER DEFAULT 0")
        if "duel_games_won" not in player_columns:
            conn.execute("ALTER TABLE players ADD COLUMN duel_games_won INTEGER DEFAULT 0")
